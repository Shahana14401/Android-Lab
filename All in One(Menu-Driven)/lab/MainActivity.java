...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(i);
        } else if (id==R.id.imgtg) {
            Intent i=new Intent(MainActivity.this, ImageToggle.class);
            startActivity(i);
        }else if (id==R.id.calc) {
            Intent i=new Intent(MainActivity.this, Calculator.class);
            startActivity(i);
        } else if (id==R.id.imGrid) {
            Intent i=new Intent(MainActivity.this, ImageGrid.class);
            startActivity(i);
        } else if (id==R.id.arr) {
            Intent i=new Intent(MainActivity.this, arrayAdapter.class);
            startActivity(i);
        }
